  ...
  return (
    <main className="max-w-[1440px] w-full mx-auto px-6 md:px-11 pt-8 pb-16">
      <div className="flex items-center justify-between mb-[88px]">
        <Link
          href="/"
          className="flex items-center justify-center w-12 h-12 rounded-[28px] bg-transparent hover:bg-[#f5f5f5] transition-colors"
      ...
      <div className="flex flex-col items-center text-center">
        <div className="relative w-[140px] mx-auto">
          <div className="relative w-[140px] h-[160px] rounded-[14px] overflow-hidden bg-[#e9e9e9]">
            <Image src={portraitPhoto} alt="Osya Dunska" fill className="object-cover" />
          </div>
          <div className="absolute -bottom-4 -right-14 w-[110px] h-[47px]">
            <Image src={osyaScript} alt="Osya" fill unoptimized />
          </div>
        </div>

        <h1
          className="mt-10 text-[28px] md:text-[40px] font-semibold"
          style={{
            letterSpacing: "-1.2px",
            lineHeight: "48px",
        ...
        >
          <span className="text-[rgba(41,38,33,0.4)] block">I own the full design</span>
          <span className="text-[rgba(41,38,33,0.4)] block">process —</span>
          <span className="text-[#171716] block">
            from the <span className="italic">first sketch</span> to
          </span>
          <span className="text-[#171716] block">a dev-ready screen</span>
        </h1>

        <p className="mt-8 text-[16px] leading-[1.6] text-[#111]/60 max-w-[600px]">
      ...
      <div className="flex flex-col gap-20 mt-16 max-w-[740px] mx-auto text-[16px] leading-[1.6] text-[rgba(23,23,22,0.8)]">
        ...
        <div className="flex flex-col gap-6">
          <h2 className="text-[18px] font-bold uppercase text-[#171716]">How I Work</h2>
          <p>
      ...
      <div className="flex flex-col items-center text-center mt-24">
        <div className="relative w-[140px] h-[160px]">
          <div className="absolute inset-0 rounded-[14px] overflow-hidden bg-[#e9e9e9]">
            <Image src={littleMePhoto} alt="Little me" fill className="object-cover" />
          </div>
          <div className="absolute -top-4 -right-8 w-[110px] h-[36px]">
            <Image src={littleMeScript} alt="little me" fill unoptimized />
          </div>
        </div>
      </div>

      <div className="flex flex-col items-center text-center gap-0 mt-8 mb-4">
        <p
          className="text-[14px] text-[#292621]"
          style={{ letterSpacing: "0.0128px", marginTop: "32px" }}
        >
        ...
        <p
          ...
          style={{ fontFamily: "var(--font-cormorant)", marginTop: "114px" }}
        >
          Made with love by{" "}
          <span
            className="underline"
