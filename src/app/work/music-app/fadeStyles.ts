...
//
// The vertical ramp is Figma's own: transparent to solid #000208 by 80.2%. It
...
// seam.
// Figma's ramp is `rgba(0,2,8,0) 0% -> #000208 80.2%`, holding solid to the
...
export const fadeGradient =
  "linear-gradient(to bottom, rgba(0,2,8,0) 0%, #000208 80.2%, #000208 88%, rgba(0,2,8,0) 100%)";

// Figma's ramp verbatim — transparent to #000208 by 80.2%, then solid to the
...
// #000208 — the same colour the ramp ends on, so there is no edge to see.
export const fadeGradientSolid =
  "linear-gradient(to bottom, rgba(0,2,8,0) 0%, #000208 80.2%, #000208 100%)";
