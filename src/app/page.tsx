    ...
    >
      <div className="absolute left-8 right-8 top-[100px] flex flex-col gap-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-white/60 text-sm tracking-tight">/ {year}</span>
        </div>
        <p className="text-white/50 text-base leading-6">{description}</p>
      </div>
      <ArrowButton />
    </Link>
  );
  ...
  return (
    <main className="max-w-[1440px] w-full mx-auto px-6 md:px-11 pt-8 pb-16">
      ...
      <div className="flex flex-col md:flex-row md:gap-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-[22px] flex-1 mt-8 md:mt-0">
          ...
          >
            <Image src={musicAppHero} alt="Music App preview" fill className="object-cover" />
          </Link>
          <CaseTextCard
            title="Music App"
            year="2025"
          ...
          <div className="group contents">
            <div className="relative aspect-square squircle bg-[#292621] overflow-hidden">
              <div className="absolute left-8 right-8 top-[100px] flex flex-col gap-6">
                <div className="flex items-center gap-2">
                  <span className="text-white text-2xl font-medium tracking-tight">Aura</span>
                  <span className="text-white/60 text-base tracking-tight">/ 2026</span>
                </div>
      ...
      <p
        className="text-center text-[16px] text-[rgba(41,38,33,0.6)] font-semibold mt-16"
        style={{ fontFamily: "var(--font-cormorant)" }}
      >
        Made with love by{" "}
